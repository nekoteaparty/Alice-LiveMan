...
public class BilibiliApiUtil {
    ...
    private static final String DYNAMIC_POST_PARAM = "dynamic_id=0&type=4&rid=0&content=#Vtuber##%s# 正在直播：%s %s&at_uids=&ctrl=[]&csrf_token=%s&csrf=%s";
    ...
    public void postDynamic(AccountInfo accountInfo) {
        ...
        try {
            ...
            postData = String.format(DYNAMIC_POST_PARAM, videoInfo.getChannelInfo().getChannelName(), videoInfo.getTitle(), accountInfo.getRoomUrl(), csrfToken, csrfToken);
